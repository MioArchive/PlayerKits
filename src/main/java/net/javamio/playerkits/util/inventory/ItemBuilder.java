...
public class ItemBuilder {
    ...
    public ItemBuilder name(String name) {
        return name(ColorUtil.translateColorCodes(name));
    }
    ...
    public ItemBuilder skullOwner(String playerName){
        ...
        if (itemMeta != null) {
            Bukkit.getAsyncScheduler().runNow(PlayerKits.getInstance(), e -> itemMeta.setOwnerProfile(Bukkit.getOfflinePlayer(UUID.fromString(playerName)).getPlayerProfile()));
        }
    ...
    public ItemBuilder skullOwner(Player player) {
        ...
        if (itemMeta != null) {
            Bukkit.getAsyncScheduler().runNow(PlayerKits.getInstance(), e -> itemMeta.setOwnerProfile(player.getPlayerProfile()));
        }
        ...
        if (itemMeta != null) {
            player.getPlayerProfile()
                    ...
                    .thenAcceptAsync(itemMeta::setOwnerProfile,
                            runnable -> Bukkit.getScheduler().runTask(PlayerKits.getInstance(), runnable));
        }
    ...
    public ItemBuilder addContainerValue(String key, String value){
        ItemMeta meta = itemStack.getItemMeta();
        if(meta != null){
            meta.getPersistentDataContainer().set(new NamespacedKey(PlayerKits.getInstance(), key), PersistentDataType.STRING, value);
            itemStack.setItemMeta(meta);
        }
        return this;
    }
    ...
    public ItemBuilder addContainerValue(String key, int value){
        ItemMeta meta = itemStack.getItemMeta();
        if(meta != null){
            meta.getPersistentDataContainer().set(new NamespacedKey(PlayerKits.getInstance(), key), PersistentDataType.INTEGER, value);
            itemStack.setItemMeta(meta);
        }
        return this;
    }
    ...
    public ItemBuilder addContainerValue(String key, boolean value){
        ItemMeta meta = itemStack.getItemMeta();
        if(meta != null){
            meta.getPersistentDataContainer().set(new NamespacedKey(PlayerKits.getInstance(), key), PersistentDataType.BOOLEAN, value);
            itemStack.setItemMeta(meta);
        }
        return this;
    }
